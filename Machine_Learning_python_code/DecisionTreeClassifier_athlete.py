...
class DecisionTree:
    ...
    def __init__(self,data,target='label',depth=None,v=0):
        self.data = data
        self.target = target
        self.root = None
        self.depth = depth
...
if __name__ == '__main__':
    ...
    dataset = {'height':['68','65','71','70','67','65','72','71','65','67','70','63','62','67','71','60','74'],              'weight':['175','120','156','345','165','108','150','170','180','130','138','170','135','220','175','180','195'],
    'shoe_size':['10','9','12','11','12','7','10','11','9','9','9','9','6','10','11','6','12'],
    'label':['T','T','T','T','T','F','T','T','T','T','T','F','F','T','T','T','T']}

    data = pd.DataFrame(dataset)[:]
       
    tree = DecisionTree(data,'label',depth=None,v=1)
    root = tree.fit()
    ...
    for i in range(len(data)):
        ...
        if pred and data.loc[i].label:
            score+=1
        elif not pred and not data.loc[i].label:
            score+=1
